...
int main()
{
    ...
    Shader ourShader("shaders/depth_testing.vert", "shaders/AlphaClipping.frag");
    // prepare
    ...
    unsigned int window_texture = loadTexture("textures/blending_transparent_window.png");
