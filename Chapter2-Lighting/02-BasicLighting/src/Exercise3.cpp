...
int main()
{
	...
	Shader cubeShader("shaders/vertex_exercise3.vert", "shaders/fragment_exercise3.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::vec3 lightPos_viewSpace = glm::vec3(camera.GetViewMatrix() * glm::vec4(lightPos,1.0f));
		cubeShader.setVec3("lightPos_viewspace", lightPos_viewSpace);

		glm::vec3 camPosition_viewspace = glm::vec3(camera.GetViewMatrix() * glm::vec4(camera.Position, 1.0f));
		cubeShader.setVec3("eyePos_viewspace", camPosition_viewspace);
		cubeShader.setFloat("Shininess", 32.0f);
		cubeShader.setFloat("specularMultiplier", 0.5f);
