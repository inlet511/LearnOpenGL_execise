...
int main()
{
	...
	Shader lampShader("Shaders/vertexShader.vert", "Shaders/LampFrag.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			// transpose inverse World Matrix
			glm::mat4 TIWorldMatrix = glm::transpose(glm::inverse(model));
			//lightingShader.setMat4("transposeInverseModelMatrix", TIWorldMatrix);
