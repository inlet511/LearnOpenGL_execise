...
int main()
{
	...
	Shader cubeShader("shaders/vertex.vert", "shaders/fragment_spot_light_softedge.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		cubeShader.setFloat("light.outerCone", glm::cos(glm::radians(outer_cone)));
		cubeShader.setFloat("light.fallOff", fallOff);
